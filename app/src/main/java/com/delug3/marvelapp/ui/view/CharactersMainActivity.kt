package com.delug3.marvelapp.ui.view
...
import com.delug3.marvelapp.utils.network.RetrofitClient
import com.delug3.marvelapp.utils.base.CharactersViewModelFactory
import com.delug3.marvelapp.utils.workers.CharactersApplication
...
class CharactersMainActivity : AppCompatActivity()  {
    ...
    private fun setUpViewModel() {
        charactersViewModel = ViewModelProvider(this, CharactersViewModelFactory(RetrofitClient.charactersApiService, (application as CharactersApplication).repository)).get(

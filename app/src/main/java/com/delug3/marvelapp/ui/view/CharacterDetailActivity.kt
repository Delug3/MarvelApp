...
import com.delug3.marvelapp.utils.base.CharacterDetailsViewModelFactory
...
class CharacterDetailActivity : AppCompatActivity() {
    ...
    private fun setUpViewModel() {
        characterDetailViewModel = ViewModelProvider(
            this,
            CharacterDetailsViewModelFactory(RetrofitClient.charactersApiService)
